...
function drawSpeedometerColourArc(options) {
  ...
  drawSpeedometerPart(options, 0.9, "rgb(255, 0, 0)", startOfRed);
  drawSpeedometerPart(options, 0.9, "rgb(255,165,0)", startOfOrange);
	drawSpeedometerPart(options, 1.0, "rgb(82, 240, 55)", startOfGreen);
	drawSpeedometerPart(options, 1.0, "rgb(255,165,0)", endOfGreen);
	drawSpeedometerPart(options, 1.0, "rgb(255, 0, 0)", endOfOrange);
